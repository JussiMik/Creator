...
public class ProductionBarWood : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        faithMaximumTime = gameObject.GetComponentInParent<WoodWorkshopCS>().originalWoodTime;
    ...
    void Update()
    {
        ...
        {
            if (gameObject.GetComponent<WoodWorkshopCS>().woodCollected == true && startTimer == false)
            {
                faithTimer = gameObject.GetComponent<WoodWorkshopCS>().woodProductionTimeLength; // Sue me. 
                startTimer = true;
    ...
    {
        if (gameObject.GetComponent<WoodWorkshopCS>().woodTimer == true)
        {
