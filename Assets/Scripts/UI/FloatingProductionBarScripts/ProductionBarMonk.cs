...
public class ProductionBarMonk : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        faithMaximumTime = gameObject.GetComponentInParent<ConversionTempleCS>().originalMonkConversionTimeLength;
    ...
    void Update()
    {
        ...
        {
            if (gameObject.GetComponent<ConversionTempleCS>().monkCollected == true && startTimer == false)
            {
                faithTimer = gameObject.GetComponent<ConversionTempleCS>().monkConversionTimeLength; // Sue me. 
                startTimer = true;
    ...
    {
        if (gameObject.GetComponent<ConversionTempleCS>().conversionTimer == true)
        {
